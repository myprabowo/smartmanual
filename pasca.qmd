...
-   **Kirim ke Keuangan:** Pastikan data jadwal sudah final dan benar. Klik tombol **Kirim** (ikon pesawat kertas hijau). Sistem akan mengirimkan rekapitulasi lengkap (termasuk nama pengajar, NIP, NIK, dan nomor rekening) langsung ke sistem Keuangan (via Webhook) untuk memproses pencairan honorarium.
...
3.  **Isi Template:** Buka *file* CSV yang diunduh, lalu lengkapi kolom Nomor Sertifikat dan Tanggal Sertifikat.
4.  **Upload Data:** Klik **Upload Data** dan masukkan *template* yang telah Anda lengkapi.
5.  **Cetak Sertifikat:** Klik tombol ini, dan sistem akan memproses *file* sertifikat yang siap untuk didistribusikan.
