...
SMART dapat diakses secara online melalui jaringan internet umum pada [tautan berikut](https://docker.maiaidi.my.id){.uri}.

![Tampilan layar login aplikasi SMART.](images/01-login-screen.png){#fig-login-screen fig-align="center" width="100%"}

![Tampilan layar utama aplikasi SMART.](images/02-master-program.png){#fig-layar-utama fig-align="center" width="100%"}
...
-   **Melihat Teks Lengkap:** Jika ada teks yang terpotong di dalam tabel, cukup arahkan kursor (*hover*) ke sel tersebut untuk melihat teks selengkapnya (lihat @fig-layar-utama baris 1).
